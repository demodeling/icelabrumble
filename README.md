...
A single-page HTML5 canvas fighter: pick an IceLab fighter, dodge the charge, duck the horn, fill the meter, land your special and watch the false positive explode into DNA. The bench is short for now — **Anton** rides a skateboard and throws the rhino over his hip (Skate-Jitsu Throw), **June** kicks above her own head (Sky-High Axe Kick), **Sarah** shouts mean Australian things at it until it loses health (Strewth Barrage), **Aswin**, behind very big glasses, dresses up in black tie and talks so loudly the rhino takes damage and runs (Black-Tie Boom), **Åke** puts his fingers to his temples, gathers a Claude spark between his hands and knocks the rhino out on the spot (Claude Mind Spark), **Abigail** shoots water from her fingertips that soaks the rhino and washes it back (Fingertip Flood), **Sasha**, who looks like a maroon cactus, fires three fans of spines (Spine Storm), and **Suvam** brings the Punjab desert with him, vanishes in the sand and turns up on the rhino's back with a headlock (Desert Headlock); the rest of the IceLab members page comes back later. Eleven rounds: the eight from the sister game, Swebits Rumble, plus IceLab's own three. Works in Safari, Chrome, iPhone, iPad and desktop; installable as a home-screen app; keyboard or touch. The CREDITS button on the title screen says what IceLab is and why it is worth celebrating.
